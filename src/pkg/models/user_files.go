...
type UserFiles struct {
	UserID      string               `gorm:"type:VARCHAR;not null;uniqueIndex:idx_user_file" json:"user_id"` // 用户ID
	FileID      string               `gorm:"type:VARCHAR;not null;uniqueIndex:idx_user_file" json:"file_id"`  // 文件ID
