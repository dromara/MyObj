...
type CloudTask struct {
	...
	TaskType     string                `gorm:"type:VARCHAR(255);not null" json:"task_type"` // parse, download, save
	...
	SharePwd     string                `gorm:"type:VARCHAR(255)" json:"-"`
	...
	TargetPath   string                `gorm:"type:VARCHAR(255)" json:"target_path"`
...
type CloudTaskFile struct {
	...
	Status      int                  `gorm:"type:INTEGER;not null;default:0" json:"status"`
	LocalPath   string               `gorm:"type:VARCHAR(255)" json:"local_path"`
	LocalFileID string               `gorm:"type:VARCHAR(255)" json:"local_file_id"`
	ErrorMsg    string               `gorm:"type:TEXT" json:"error_msg"`
	CreatedAt   custom_type.JsonTime `gorm:"type:DATETIME;not null" json:"created_at"`
	UpdatedAt   custom_type.JsonTime `gorm:"type:DATETIME;not null" json:"updated_at"`
}
