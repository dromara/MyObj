<template>
  <div class="user-info-form">
    <el-form ref="formRef" :model="userForm" :rules="rules" label-width="120px" label-position="left">
...
<script setup lang="ts">
  ...
  const rules: FormRules = {
    ...
    email: [{ type: 'email', message: t('settings.userInfo.emailFormat'), trigger: 'blur' }],
    phone: [{ pattern: /^1[3-9]\d{9}$/, message: t('settings.userInfo.phoneFormat'), trigger: 'blur' }]
  }
