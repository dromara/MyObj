<template>
  <div class="password-form">
    <el-form ref="formRef" :model="passwordForm" :rules="rules" label-width="120px" label-position="left">
...
<script setup lang="ts">
  ...
  const rules: FormRules = {
    oldPassword: [{ required: true, message: t('settings.password.oldPasswordPlaceholder'), trigger: 'blur' }],
    newPassword: [
