              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <template v-if="!row.isFolder">
                    ...
                    <el-dropdown-item v-if="isArchiveFile(row)" command="extract" icon="FolderOpened">{{ t('extract.extract') }}</el-dropdown-item>
...
<script setup lang="ts">
  ...
  import type { FileItem, FileListResponse, FolderItem } from '@myobj/shared'
