    ...
    >
      <el-form :model="formData" :rules="formRules" ref="formRef" label-width="100px">
        <el-form-item label="磁盘路径" prop="disk_path">
          <el-input v-model="formData.disk_path" placeholder="例如: D:\storage 或 /mnt/storage" />
        </el-form-item>
        <el-form-item label="数据路径" prop="data_path">
          <el-input v-model="formData.data_path" placeholder="例如: D:\storage\data 或 /mnt/storage/data" />
        </el-form-item>
        <el-form-item label="大小(GB)" prop="size">
          <el-input-number v-model="formData.size" :min="0" :max="999999" style="width: 100%" />
        </el-form-item>
      </el-form>
      <template #footer>
