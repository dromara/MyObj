export default {
  ...
  enterprise: {
    ...
    noEnterprise: 'Not joined any enterprise',
    create: 'Create Enterprise',
    createSuccess: 'Enterprise created successfully',
    dissolve: 'Dissolve Enterprise',
    dissolveConfirm: 'Are you sure you want to dissolve this enterprise? This action cannot be undone. All shared files and member data will be deleted.',
    dissolveSuccess: 'Enterprise dissolved',
    ...
    enableDesc: 'Members can access the enterprise shared space when enabled',
    disableDesc: 'All members will lose access to the enterprise shared space when disabled',
    ...
    member: {
      ...
      removeConfirm: 'Are you sure you want to remove this member from the enterprise?',
      removeSuccess: 'Member removed',
      leave: 'Leave Enterprise',
      leaveConfirm: 'Are you sure you want to leave this enterprise?',
      leaveSuccess: 'Left enterprise',
      join: 'Join Enterprise',
      joinSuccess: 'Joined enterprise successfully',
      joinByCode: 'Join by invite code',
      accept: 'Accept Invitation',
      acceptSuccess: 'Invitation accepted',
      changeRole: 'Change Role',
      changeRoleSuccess: 'Role changed',
      userName: 'Username',
      roleName: 'Role',
      joinedAt: 'Joined At',
      status: 'Status',
    ...
    role: {
      ...
      delete: 'Delete Role',
      deleteConfirm: 'Are you sure you want to delete this role? Associated members will be assigned the default role.',
      deleteSuccess: 'Role deleted',
      name: 'Role Name',
      isDefault: 'Default Role',
      isAdmin: 'Admin',
      powers: 'Permissions',
      assignPowers: 'Assign Permissions'
    },
    space: {
      title: 'Shared Space',
      usage: 'Space Usage',
      ...
      emptyFolder: 'Folder is empty',
      emptyFolderDesc: 'Upload files or create folders to start using the shared space'
    },
    audit: {
      title: 'Audit Log',
      list: 'Log List',
