export default {
  ...
  enterprise: {
    ...
    dissolve: '解散企业',
    dissolveConfirm: '确定要解散该企业吗？此操作不可恢复，所有共享文件、成员数据将被删除。',
    dissolveSuccess: '企业已解散',
    transfer: '转让所有权',
    ...
    enableDesc: '启用后，成员可以正常访问企业共享空间',
    disableDesc: '禁用后，所有成员将无法访问企业共享空间',
    setQuota: '设置存储配额',
    setQuotaSuccess: '配额已更新',
    info: {
      title: '企业信息',
      name: '企业名称',
      description: '企业描述',
    ...
    member: {
      ...
      inviteSuccess: '邀请已发送',
      remove: '移除成员',
      removeConfirm: '确定要将该成员移出企业吗？',
      removeSuccess: '成员已移除',
      leave: '退出企业',
      leaveConfirm: '确定要退出该企业吗？',
      leaveSuccess: '已退出企业',
      join: '加入企业',
      joinSuccess: '已成功加入企业',
      joinByCode: '通过邀请码加入',
    ...
    role: {
      ...
      updateSuccess: '角色已更新',
      delete: '删除角色',
      deleteConfirm: '确定要删除该角色吗？关联的成员将恢复默认角色。',
      deleteSuccess: '角色已删除',
      name: '角色名称',
      isDefault: '默认角色',
      isAdmin: '管理员',
    ...
    space: {
      ...
      noPermission: '没有操作权限',
      emptyFolder: '文件夹为空',
      emptyFolderDesc: '上传文件或创建文件夹开始使用共享空间'
    },
    audit: {
      title: '审计日志',
      list: '日志列表',
